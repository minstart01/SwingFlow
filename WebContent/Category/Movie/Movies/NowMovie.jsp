...
<div class="box"><!-- 전체 메뉴를 .box 를 통해서 둘러 쌉니다. -->
    <ul class="main_menu">
        <li class="active"><a href="/SwingFlow/Category/Movie/Movies/BoxOffice.jsp">개봉일순</a></li>
        <li><a href="/SwingFlow/Category/Movie/Movies/ViewOffice.jsp">예매순</a></li>
        <li><a href="/SwingFlow/Category/Movie/Movies/PointOffice.jsp">관람순</a></li>
        <li><a href="/SwingFlow/Category/Movie/Movies/PointOffice.jsp">평점순</a></li>
        <li><a href="/SwingFlow/Category/Movie/Movies/PointOffice.jsp">가나다순</a></li>
 	 </ul>
</div>
