...
<body>
<%
// String jobs[] = { "자바개발자,닷넷개발자,시스템개발자", 
// 		"웹기획자,it기획자,도서기획자", 
// 		"웹디자이너,일러스트레이터,아트디렉터"};

// int index = Integer.parseInt(request.getParameter("jobs"));
%>
...
<tr>
	...
	<input type="submit" value="등록하기" onclick="nextEdit()"/>
