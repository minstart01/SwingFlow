...
<body class="jqtransformdone" style="visibility: visible; opacity: 1;">
	...
	<div class="lymSec">
		<div class="wrap">
			...
			<!-- 			<div class="gnbSec" style="width:200px; "> -->
			<!-- 				<div class="widFix fixWid4" -->
			<!-- 					style="width: 200px; padding-right: 0px;"> -->
			<!-- 					<div class="inSec"> -->
			<!-- 						<div class="lineSec" style="width:200px; "> -->
			<!-- 							<a href="javascript:;" -->
			...
			<!-- 										<label for="label-totalSearch" -->
			<!-- 											class="label-totalSearch hd-lab">검색어를 입력해주세요.</label> <span -->
