...
<link rel="stylesheet" type="text/css" href="/SwingFlow/Css/Shopping/ShopJoin.css" />
...
<div style="float:left; margin-left: 5px;"><h1>쇼핑몰 등록</h1></div>
<hr style="width:720px; border:1px solid #d9d9d9;" />
</div>
	<table class="join_table" cellpadding="6"  >
		<tr>
        	<td  class="first_td"><label>쇼핑몰코드</label></td>
            <td><input type="text" class="text1" id="shopSeq" name="shopSeq" readonly="readonly"/></td>
        </tr>
    	<tr>
        	<td class="first_td"><label for="shopName">쇼핑몰이름</label></td>
            <td><input type="text" class="text1" id="shopName" name="shopName" onkeyup="regChk();" /></td>
        </tr>
        <tr>
        	<td class="first_td"><label for="adType">adType</label></td>
            <td><input type="text" class="text1" id="adType" name="adType" onkeyup="regChk();" /></td>
        </tr>
